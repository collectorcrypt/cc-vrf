    ...
    <section className="container-wide flex flex-col gap-8" id="claude-skill">
      <header className="flex flex-col gap-3">
        ...
        <p className="max-w-3xl text-ink-300">
          ...
          that teaches an LLM how to wire cc-vrf into a Solana project
          end-to-end &mdash; install commands, operator setup, per-call proof +
          commit, verifier code, common pitfalls. Hand it to Claude (or any
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="card flex flex-col gap-3">
          ...
          <p className="text-xs text-ink-400">
            ...
            &mdash; especially the env-var setup for the operator&rsquo;s secret
            key.
          </p>
        </div>
        ...
        <div className="card flex flex-col gap-3">
          ...
          <p className="text-sm text-ink-300">
            ...
            your Claude Code skills, register cc-vrf so Claude can invoke it by
            name:
          </p>
